...
public class Cell implements CanOwnUnit {
    ...
    private GameField _field_owner;

    public GameField getOwner() {
        return _field_owner;
    }

    public Cell(GameField owner, CellPosition position) {
        _field_owner = owner;
        _pos = position;
    }
    ...
    public Cell getNeighbor(Direction direct) {
    ...
    public double getCharacteristic(String name) {
